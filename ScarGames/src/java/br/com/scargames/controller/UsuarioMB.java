...
public final class UsuarioMB implements Serializable{
    ...
    public String inserir(){
        ...
        if (service.inserir(usuario)){
            UtilMessages.messageInfo("Usuario cadastrado com sucesso!");
            this.listar();
            return "list.xhtml?faces-redirect=true";
        }else{
            UtilMessages.messageError("Ocorreu um erro ao cadastrar o usuario!");
            return null;
        }
    }
    ...
    public String alterar(){
        ...
        if (service.alterar(usuario)){
            UtilMessages.messageInfo("Usuário alterada com sucesso!");
            this.listar();
            return "list.xhtml?faces-redirect=true";
        }else{
            UtilMessages.messageError("Ocorreu um erro ao alterar o usuário!");
            return null;
        }
    }
    ...
    public String excluir(Usuario usuario){
        ...
        if (service.excluir(usuario)){
            UtilMessages.messageInfo("Usuário excluído com sucesso!");
            this.listar();
            return "list.xhtml?faces-redirect=true";
        }else{
            UtilMessages.messageError("Ocorreu um erro ao excluir o usuário!");
            return null;
        }
    }
